...
def test_query_exact():
    ...
    # TODO: Write an ORM query here that will generate an index-only scan
    #   on the varchar colum you indexed
...
def test_query_iexact():
    start = time.perf_counter()
    # TODO: Write your `__iexact` ORM query here
    end = time.perf_counter()
    return end - start
...
# TODO: update this to reference the correct model
